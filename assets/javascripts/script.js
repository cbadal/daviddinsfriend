$(document).ready(function(){
  ...
  if (!isMobile) {
    ...
    var s = skrollr.init();
  	$("#contentWrapper").on('DOMNodeInserted', 'div', function(){
        ...
        // Get the next photo URL and check if it exists on server.
  			var nextImageURL = "assets/images/" + (++i) + ".jpg";
	    	$.ajax({
			    url: nextImageURL,
			    type:'HEAD',
			    success: function() {
    ...
    // First and second photos' positions are fixed, so we start attaching dynamically from #3.
  	$("#contentWrapper").append("<div id=\"img3\"><img src=\"assets/images/3.jpg\" /></div>");
    ...
    $("#contentWrapper").append("<div id=\"img3\"><img src=\"img/loading.gif\" data-src=\"assets/images/3.jpg\" /></div>");
  }
